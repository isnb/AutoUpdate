...
应用程序向导已为您创建了此 Test1 DLL。  此 DLL 不仅演示 
Microsoft 基础类的基本使用方法，还可作为您编写 DLL 的起点。

本文件概要介绍组成 Test1 DLL 的每个文件的内容。
...
Test1.h
    这是 DLL 的主头文件。  它声明了 CTest1App 类。

Test1.cpp
    这是主 DLL 源文件。  它包含 CTest1App 类。
...
StdAfx.h，StdAfx.cpp
    这些文件用于生成名为 Test1.pch 的预编译头 (PCH) 文件和名为 
    StdAfx.obj 的预编译类型文件。
